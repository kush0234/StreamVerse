    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="pt-16">
        ...
        {!type && carouselItems.length > 0 && (
          <div className="relative h-[55vh] sm:h-[65vh] md:h-[75vh] lg:h-[85vh] mb-8">
            {carouselItems.map((item, index) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 p-4 sm:p-8 md:p-12 max-w-xs sm:max-w-lg md:max-w-2xl">
                  <div className="animate-fade-in">
                    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 md:mb-4 text-shadow">{item.title}</h1>
                    <div className="flex flex-wrap gap-2 sm:gap-4 text-xs sm:text-sm mb-3 md:mb-4">
                      <span className="px-2 sm:px-3 py-1 bg-red-600 rounded font-semibold">TRENDING</span>
                      {item.rating && (
                    ...
                    {item.description && (
                      <p className="text-sm sm:text-base md:text-lg text-gray-300 mb-4 md:mb-6 line-clamp-2 md:line-clamp-3">{item.description}</p>
                    )}

                    <div className="flex gap-2 sm:gap-3">
                      <button
                        onClick={() => handleHeroClick(item, 'play')}
                        className="flex items-center gap-2 bg-white text-black px-4 sm:px-8 py-2 sm:py-3 rounded-lg font-semibold hover:bg-gray-200 transition transform hover:scale-105 text-sm sm:text-base"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 bg-gray-700/80 backdrop-blur-sm px-4 sm:px-8 py-2 sm:py-3 rounded-lg font-semibold hover:bg-gray-600/80 transition transform hover:scale-105 text-sm sm:text-base"
                      >
