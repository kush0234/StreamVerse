...
export default function ArtistDetailPage() {
  ...
  const loadArtistData = async () => {
    ...
    try {
      const data = await api.getArtistDetail(token, artistName);
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="pt-20 px-8 py-8">
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-8">
          <div className="w-64 h-64 bg-gray-800 rounded-full overflow-hidden flex-shrink-0 mx-auto md:mx-0">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-4">{artistData.name}</h1>
            
            <div className="flex flex-wrap gap-4 justify-center md:justify-start text-gray-400 mb-6">
              <span>{artistData.track_count} tracks</span>
              <span>•</span>
              <span>{artistData.total_plays} total plays</span>
            </div>
              ...
              <div className="space-y-2">
                {tracks.map((track, index) => (
                  ...
                  >
                    ...
                    {!track.album && <div className="hidden md:block w-48"></div>}
